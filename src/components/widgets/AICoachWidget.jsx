...
export default function AICoachWidget({ aiTip }) {
  return (
    <div className="bg-gradient-to-r from-purple-100 to-blue-50 dark:from-slate-800 dark:to-slate-800 border-2 border-purple-200 dark:border-slate-700 rounded-[2rem] p-6 relative overflow-hidden transition-colors">
