            ...
            >
              <div className="p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-end">
                  <div className="flex items-center gap-1.5 bg-white dark:bg-slate-900 p-2 rounded-xl border-2 border-slate-100 dark:border-slate-800">
                      ...
                      return (
                        <div key={idx} className="flex flex-col items-center gap-1">
                          ...
                          <button
                            ...
                            disabled={isFuture}
                            className={`w-5 h-5 rounded-md flex items-center justify-center transition-colors border-2 focus:outline-none focus:ring-2 focus:ring-green-400 ${isFuture ? 'bg-slate-50 dark:bg-slate-800 border-dashed border-slate-200 dark:border-slate-700 cursor-not-allowed' : isCompleted ? 'bg-green-500 border-green-600 text-white' : 'bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 cursor-pointer'}`}
