    ...
    <div className="bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 rounded-[2rem] p-4 md:p-6 transition-colors overflow-hidden">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">İstatistikler & Raporlar</h2>
        </div>
      </div>
        ...
        <section>
          ...
          <div className="space-y-2">
            {TASK_TAGS.map((tag) => {
              ...
              return (
                <div key={tag} className="flex items-center gap-2 sm:gap-3 min-w-0">
                  <span className="w-16 sm:w-20 text-xs sm:text-sm font-bold text-slate-600 dark:text-slate-300 flex-shrink-0">{tag}</span>
        ...
        <section>
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-3 min-h-[44px] rounded-xl bg-purple-500 text-white font-bold hover:bg-purple-600 touch-manipulation"
            >
