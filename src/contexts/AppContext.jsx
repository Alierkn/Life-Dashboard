...
export function AppProvider({ children }) {
  ...
  const pendingPushRef = useRef(false);
      // lastPushTimestampRef: son basarili push zamani - grace period icin kullanilir
  ...
  // Periyodik polling - FIX: 2s -> 30s, grace period 5s sonrasinda overwrite
          ...
          const doFetch = () => {
                    ...
                    fetchSync()
                      .then((data) => {
                                    ...
                                    if (serverHadData) applyServerData(data);
  ...
  // Degisiklikleri sunucuya push et - debounce 500ms
